...
void Interpreter::interpret() {
    ...
    std::for_each( units.begin(), units.end(),  [this](Node* node)
    {node->accept(*(this->evalVisitor));CRBValue* value = this->evalVisitor->getResult();if (value) {/*std::cout << value->toString();*/}});
}
